...
INSERT INTO "ROLE"("CODE", "STAND_SPECIFIC") VALUES ('SCOPED_STAND_OWNER', TRUE);
...
CREATE SEQUENCE "GOOGLE_DOC_IMPORTED_ROW_ID_SEQ";
CREATE TABLE "GOOGLE_DOC_IMPORTED_ROW"
(
    "GOOGLE_DOC_IMPORTED_ROW_ID" INTEGER NOT NULL DEFAULT nextval('"GOOGLE_DOC_IMPORTED_ROW_ID_SEQ"'),
    "COL_0" TEXT NULL,
    "COL_1" TEXT NULL,
    "COL_2" TEXT NULL,
    "COL_3" TEXT NULL,
    ...
    "COL_5" TEXT NULL,
    "COL_6" TEXT NULL,
    CONSTRAINT "PK_GOOGLE_DOC_IMPORTED_ROW" PRIMARY KEY ("GOOGLE_DOC_IMPORTED_ROW_ID")
);
...
-- see https://en.wikipedia.org/wiki/Pairing_function (in particular the Cantor pairing function)
CREATE VIEW "ALLOWED_GLOBAL_ACTIONS" AS
SELECT (0.5 * (a."ACTION_ID" + ra."USER_ID") * (a."ACTION_ID" + ra."USER_ID" + 1) + ra."USER_ID") "ALLOWED_GLOBAL_ACTIONS_ID", U."EMAIL", a."CODE" "ACTION", r."CODE" "ROLE" FROM "ROLE_ASSIGNMENT" ra
...
where (a."STAND_SPECIFIC" = FALSE or r."STAND_SPECIFIC" = FALSE);

CREATE VIEW "ALLOWED_STAND_SPECIFIC_ACTIONS" AS
SELECT (0.5 * (a."ACTION_ID" + ra."USER_ID") * (a."ACTION_ID" + ra."USER_ID" + 1) + ra."USER_ID") "ALLOWED_STAND_SPECIFIC_ACTIONS_ID", u."EMAIL", a."CODE" "ACTION", r."CODE" "ROLE", s."STAND_ID" FROM "ROLE_ASSIGNMENT" ra
join "ROLE_ENABLES_ACTION" rea on ra."ROLE_ID" = rea."ROLE_ID"
join "ACTION" a on rea."ACTION_ID" = a."ACTION_ID"
join "ROLE" r on ra."ROLE_ID" = r."ROLE_ID"
join "STAND" s on (s."STAND_ID" = ra."STAND_ID" OR ra."STAND_ID" IS NULL OR r."STAND_SPECIFIC" = FALSE)
join "USER" U on ra."USER_ID" = U."USER_ID"
